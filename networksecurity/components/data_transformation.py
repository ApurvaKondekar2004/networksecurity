...
class DataTransformation:
    def __init__(self,data_validation_artifact:DataValidationArtifact,
        ...
        try:
            ...
            logging.info("Exited the Data Transformation class")
    ...
    def get_data_transformer_object(cls)->Pipeline:
        logging.info("Entered get data_tranformer_object method of Transformation class")
        try:
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            numeric_columns = input_feature_train_df.select_dtypes(include=['number']).columns
